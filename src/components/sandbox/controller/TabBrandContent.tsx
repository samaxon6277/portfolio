      ...
      <div className="space-y-3.5 pt-1 border-t border-white/5">
        ...
        <div className="space-y-1">
          ...
          <input
            ...
            style={{ colorScheme: 'dark', backgroundColor: '#141414', color: '#FFFFFF' }}
            className="w-full !bg-[#141414] border border-white/15 focus:border-champagne-gold text-xs !text-white placeholder:!text-neutral-500 p-3 rounded-xl font-sans focus:outline-none focus:!bg-[#1c1c1c] transition-colors appearance-none"
        ...
        <div className="space-y-1">
          ...
          <textarea
            ...
            style={{ colorScheme: 'dark', backgroundColor: '#141414', color: '#FFFFFF' }}
            className="w-full !bg-[#141414] border border-white/15 focus:border-champagne-gold text-xs !text-white placeholder:!text-neutral-500 p-3 rounded-xl font-sans focus:outline-none focus:!bg-[#1c1c1c] transition-colors resize-none appearance-none"
      ...
      <div className="space-y-2.5 pt-1 border-t border-white/5">
        ...
        {state.showPromoBanner && (
          <input
            ...
            style={{ colorScheme: 'dark', backgroundColor: '#141414', color: '#FFFFFF' }}
            className="w-full !bg-[#141414] border border-white/15 focus:border-champagne-gold text-xs !text-white placeholder:!text-neutral-500 p-3 rounded-xl font-mono focus:outline-none focus:!bg-[#1c1c1c] transition-colors appearance-none"
