...
export default function LegalPages({ type }: LegalPagesProps) {
  ...
  return (
    <div className="min-h-screen pt-24 md:pt-32 pb-24 text-left font-sans transition-colors duration-300" id={`legal-page-${type}`}>
        ...
        <>
          ...
          <div className="max-w-4xl mx-auto px-6 space-y-8">
            <div className="border-b border-black/5 dark:border-white/5 pb-6">
              <span className="text-[10px] font-mono text-[#D6B46A] tracking-wider uppercase font-bold block">Compliance &amp; Security</span>
              <h1 className={`font-display text-3xl sm:text-4xl font-bold mt-2 uppercase tracking-wide ${
                isDark ? 'text-[#F5F5F7]' : 'text-[#1D1D1F]'
              }`}>Privacy Policy</h1>
              <p className="text-xs text-[#8E8E93] mt-1">Last Updated: May 23, 2026 · Compiled by Senior Compliance Wing</p>
            </div>

            <div className="space-y-6 text-sm text-[#8E8E93] leading-relaxed">
              <section className="space-y-2">
                <h3 className={`font-display font-bold text-base uppercase ${isDark ? 'text-white' : 'text-neutral-900'}`}>1. Information Accumulation Architecture</h3>
                <p>
              ...
              <section className="space-y-2">
                <h3 className={`font-display font-bold text-base uppercase ${isDark ? 'text-white' : 'text-neutral-900'}`}>2. Storage Safeguards &amp; Confidentiality</h3>
                <p>
              ...
              <section className="space-y-2">
                <h3 className={`font-display font-bold text-base uppercase ${isDark ? 'text-white' : 'text-neutral-900'}`}>3. Cookies &amp; Frame Containment</h3>
                <p>
              ...
              <section className="space-y-2">
                <h3 className={`font-display font-bold text-base uppercase ${isDark ? 'text-white' : 'text-neutral-900'}`}>4. Regulatory Rectification</h3>
                <p>
      ...
      {type === 'terms' && (
        <>
          ...
          <div className="max-w-4xl mx-auto px-6 space-y-8">
            <div className="border-b border-black/5 dark:border-white/5 pb-6">
              <span className="text-[10px] font-mono text-[#D6B46A] tracking-wider uppercase font-bold block">Code of Operations</span>
              <h1 className={`font-display text-3xl sm:text-4xl font-bold mt-2 uppercase tracking-wide ${
                isDark ? 'text-[#F5F5F7]' : 'text-[#1D1D1F]'
              }`}>Terms &amp; Conditions</h1>
              <p className="text-xs text-[#8E8E93] mt-1">Last Updated: May 23, 2026 · Compiled by Senior Compliance Wing</p>
            ...
            <div className="space-y-6 text-sm text-[#8E8E93] leading-relaxed">
              <section className="space-y-2">
                <h3 className={`font-display font-bold text-base uppercase ${isDark ? 'text-white' : 'text-neutral-900'}`}>1. Ground Rules of Staging Actions</h3>
                <p>
              ...
              <section className="space-y-2">
                <h3 className={`font-display font-bold text-base uppercase ${isDark ? 'text-white' : 'text-neutral-900'}`}>2. Scope Boundaries of the 48-Hour Delivery Promise</h3>
                <p>
              ...
              <section className="space-y-2">
                <h3 className={`font-display font-bold text-base uppercase ${isDark ? 'text-white' : 'text-neutral-900'}`}>3. Proprietary Design Mechanics</h3>
                <p>
      ...
      {type === 'refund' && (
        <>
          ...
          <div className="max-w-4xl mx-auto px-6 space-y-8">
            <div className="border-b border-black/5 dark:border-white/5 pb-6">
              <span className="text-[10px] font-mono text-[#D6B46A] tracking-wider uppercase font-bold block">Accountable Execution</span>
              <h1 className={`font-display text-3xl sm:text-4xl font-bold mt-2 uppercase tracking-wide ${
                isDark ? 'text-[#F5F5F7]' : 'text-[#1D1D1F]'
              }`}>Refund &amp; Project Policy</h1>
              <p className="text-xs text-[#8E8E93] mt-1">Last Updated: May 23, 2026 · Compiled by Senior Compliance Wing</p>
            </div>

            <div className="space-y-6 text-sm text-[#8E8E93] leading-relaxed">
              <section className="space-y-2">
                <h3 className={`font-display font-bold text-base uppercase ${isDark ? 'text-white' : 'text-neutral-900'}`}>1. Staged Execution Insurance</h3>
                <p>
              ...
              <section className="space-y-2">
                <h3 className={`font-display font-bold text-base uppercase ${isDark ? 'text-white' : 'text-neutral-900'}`}>2. Performance &amp; Technical Compliance</h3>
                <p>
              ...
              <section className="space-y-2">
                <h3 className={`font-display font-bold text-base uppercase ${isDark ? 'text-white' : 'text-neutral-900'}`}>3. Project Changes &amp; Delays</h3>
                <p>
