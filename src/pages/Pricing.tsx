  ...
  return (
    <div className="pt-24 md:pt-32 pb-24 min-h-screen transition-colors duration-300 font-sans" id="pricing-viewport">
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className={`grid grid-cols-1 gap-8 pt-4 items-stretch ${
          ...
          {filteredPlans.map((plan) => (
            <motion.div 
              ...
              className="relative flex flex-col justify-between transition-all pt-2"
            >
              {/* Card Liquid Glass Layer Container with proper rounded corners */}
              <div 
                className={`absolute inset-0 rounded-3xl pointer-events-none overflow-hidden backdrop-blur-2xl backdrop-saturate-180 transition-all ${
                  plan.popular 
                    ? 'bg-gradient-to-br from-white/85 via-white/50 to-white/70 border-2 border-[#D6B46A] shadow-[0_24px_60px_-10px_rgba(214,180,106,0.22),0_6px_20px_rgba(214,180,106,0.1),inset_0_1.5px_2.5px_rgba(255,255,255,1),inset_0_-1.5px_2px_rgba(214,180,106,0.2)]'
                    : 'bg-gradient-to-br from-white/75 via-white/40 to-white/65 border border-white/85 shadow-[0_20px_50px_-10px_rgba(0,0,0,0.05),0_4px_16px_rgba(0,0,0,0.02),inset_0_1.5px_2px_rgba(255,255,255,1),inset_0_-1.5px_2px_rgba(255,255,255,0.4)]'
                }`}
              >
              ...
              {/* Popular badge - perfectly positioned and completely visible without clipping */}
              {plan.popular && (
                <div className="absolute -top-3.5 left-1/2 -translate-x-1/2 px-4 py-1 rounded-full bg-gradient-to-r from-[#F5DC9E] via-[#D6B46A] to-[#BFA15A] text-[#0A0A0A] text-[9.5px] font-mono font-extrabold uppercase tracking-widest whitespace-nowrap z-30 shadow-[0_4px_16px_rgba(214,180,106,0.45),inset_0_1px_1.5px_rgba(255,255,255,0.95)] border border-white/80">
